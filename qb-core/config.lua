...
QBConfig.Money.PayCheckSociety = false -- If true paycheck will come from the society account that the player is employed at, 
...
QBConfig.Server.Discord = "https://discord.gg/35rp" -- Discord invite link
QBConfig.Server.CheckDuplicateLicense = true -- Check for duplicate rockstar license on join
QBConfig.Server.Permissions = {'god', 'admin', 'mod'} -- permission list

QBConfig.Notify = {}
QBConfig.lxnotify = false
